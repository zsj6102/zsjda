...
import com.colpencil.propertycloud.Present.Home.OrderPayPresent;
...
public class OrderPayActivity2 extends ColpencilActivity implements View.OnClickListener {
    ...
    protected void initViews(View view) {
        ...
        Subscriber<RxBusMsg> subscriber = new Subscriber<RxBusMsg>() {
            ...
            public void onNext(RxBusMsg rxBusMsg) {
                switch (rxBusMsg.getType()) {
                    case 0:// 支付成功
                        MobclickAgent.onEvent(OrderPayActivity2.this, "comitPaySuc");
                        mAm.finishActivity(ScanpayActivity.class);
                        WarnDialog.showInfoAdd(OrderPayActivity2.this, "支付成功");
                        break;
                    case 1:// 支付失败
                        MobclickAgent.onEvent(OrderPayActivity2.this, "comitPayFail");
                        ToastTools.showShort(OrderPayActivity2.this, false, "支付失败");
                        break;
                    case 2:
                        loadWallet();
                        break;
        ...
        try {
            ...
            tv_paymoney_all.setText("¥" + DecimalUtil.caculateFees(price));
        } catch (Exception e) {
            e.printStackTrace();
        }
        loadWallet();
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_pay:
                ...
                if (walletInfo != null && walletInfo.isPayPassword) {
                    if (pay == 0) {
                        paycode("alipayMobilePlugin", null);
                    } else {
                        showDialog();
                    }
                } else {
                    if (pay == 0) {
                        ...
                        view.findViewById(R.id.tv_ok).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(OrderPayActivity2.this, ChangePayActivity2.class);
                ...
                .subscribe(new Subscriber<ResultInfo<WalletInfo>>() {
                    ...
                    public void onNext(ResultInfo<WalletInfo> result) {
                        if (result.code == 0) {
                            ...
                            if (result.data.ableAccount - price > 0.0001) {      //可以付款
                                iv_zhi.setImageDrawable(getResources().getDrawable(R.mipmap.un_check));
                                iv_wallet.setImageDrawable(getResources().getDrawable(R.mipmap.check));
                            ...
                            startActivity(new Intent(OrderPayActivity2.this, LoginActivity.class));
                            finish();
                        }
                    }
                });
    ...
    private void paycode(String payType, String password) {
        ...
        if (!payType.equals("alipayMobilePlugin")) {
            map.put("payPassword", Md5Utils.encode(password));
        }
        DialogTools.showLoding(this, "提示", "正在付款");
        RetrofitManager.getInstance(1, this, HostUrl.BASE_HOST_PATH + "/api/")
                .createApi(HostApi.class)
                .paytoJiazheng(map)
                ...
                .subscribe(new Subscriber<PayInfo>() {
                    ...
                    public void onNext(PayInfo resultInfo) {
                        ...
                        if (code == 0) {
                            if (pay == 0) {
                                LhjalipayUtils.getInstance(OrderPayActivity2.this).pay(resultInfo.data.reStr);
                            } else {
                                RxBusMsg rxBusMsg = new RxBusMsg();
                                rxBusMsg.setType(0);
                                RxBus.get().post("mine", rxBusMsg);
                                mAm.finishActivity(ScanpayActivity.class);
                                WarnDialog.showDetail(OrderPayActivity2.this, "付款成功", walletInfo.balancePaymentUrl);
                            }
                        } else if (code == 3) {
                            startActivity(new Intent(OrderPayActivity2.this, LoginActivity.class));
                            finish();
                        } else {
                            ToastTools.showShort(OrderPayActivity2.this, false, message);
                        }
                    }
                });
    }
    ...
    private void showDialog() {
        if (dialogPlus == null) {
            ...
            util.setOnOkClick(new KeyboardUtil.OnOkClick() {
                ...
                public void onOkClick() {
                    if (passwordView.mText.toString().length() < 6) {
                        ToastTools.showShort(OrderPayActivity2.this, "请输入完成的支付密码");
                    } else {
            ...
            tv_forget.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (walletInfo != null && walletInfo.isPayPassword) {
                        Intent intent = new Intent(OrderPayActivity2.this, ForgetPayActivity.class);
                        startActivity(intent);
                    } else {
                        Intent intent = new Intent(OrderPayActivity2.this, ChangePayActivity2.class);
                        intent.putExtra("state", 2);
