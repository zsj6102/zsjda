...
public class YaPayListActivity extends ColpencilActivity implements PayListView, SwipeRefreshLayout.OnRefreshListener, AutoLoadRecylerView.loadMoreListener {
    ...
    protected void initViews(View view) {
        ...
        payItemsId = getIntent().getIntExtra("payItemsId", 0);
        ...
        switch (flag){
            ...
            case 6:
                ...
                break;
            case 7:
                tv_title.setText("充电位费用");
                break;
            case 8:
                tv_title.setText("押金管理费用");
                break;
        }
        ...
        adapter = new PayListAdapter(this,lists, R.layout.item_pay,payItemsId,flag);
