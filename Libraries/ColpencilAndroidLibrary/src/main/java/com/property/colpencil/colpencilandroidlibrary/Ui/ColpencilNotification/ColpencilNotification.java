package com.property.colpencil.colpencilandroidlibrary.Ui.ColpencilNotification;
 ...
 * @date 2016/8/19
 */
public class ColpencilNotification implements View.OnTouchListener {
    ...
    public ColpencilNotification(Builder builder) {
    ...
    private void setContentView(Context context, Builder builder) {
        ...
        ll_bg = (LinearLayout) mContentView.findViewById(R.id.ll_bg);
    ...
    public ColpencilNotification show() {
        if (!isShowing) {
            isShowing = true;
    ...
    public void setColor(int color) {
        if (-1 != color) {
            ll_bg.setBackgroundColor(mContext.getResources().getColor(color));
        }
    }
    ...
    public static class Builder {
        ...
        public ColpencilNotification build() {

            if (null == context)
                throw new IllegalArgumentException("the context is required.");

            return new ColpencilNotification(this);
        }
