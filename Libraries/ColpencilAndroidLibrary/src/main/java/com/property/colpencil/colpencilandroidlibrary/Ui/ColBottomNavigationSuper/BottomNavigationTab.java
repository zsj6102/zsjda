...
class BottomNavigationTab extends FrameLayout {
    ...
    public void initialise(boolean setActiveColor) {
        ...
        if (getPosition()==2){
            ...
            layoutParams.height = UITools.dp2px(getContext(),50);
            layoutParams.width = UITools.dp2px(getContext(),70);
            layoutParams.setMargins(0,UITools.dp2px(getContext(),14),0,0);
