package com.property.colpencil.colpencilandroidlibrary.Ui.ColBottomNavigationSuper;
...
import com.property.colpencil.colpencilandroidlibrary.Ui.ColBottomNavigationSuper.behaviour.BottomNavBarFabBehaviour;
import com.property.colpencil.colpencilandroidlibrary.Ui.ColBottomNavigationSuper.behaviour.BottomVerticalScrollBehavior;
...
public class BottomNavigationBar extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, UITools.fetchContextColor(context, R.attr.colorAccent));
            ...
            mElevation = typedArray.getDimension(R.styleable.BottomNavigationBar_bnbElevation, getResources().getDimension(R.dimen.bottom_navigation_elevation2));
            ...
            mActiveColor = UITools.fetchContextColor(context, R.attr.colorAccent);
            mInActiveColor = Color.LTGRAY;
            mBackgroundColor = Color.WHITE;
            mElevation = getResources().getDimension(R.dimen.bottom_navigation_elevation2);
        }
    }
