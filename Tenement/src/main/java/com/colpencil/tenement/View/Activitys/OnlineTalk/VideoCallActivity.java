...
import com.colpencil.tenement.Tools.CameraHelper;
            ...
            if (!cameraHelper.isStarted()) {
                if (!isInComingCall) {
                    try {
                        ...
                        ToastTools.showShort(VideoCallActivity.this,false,getString( R.string.is_not_yet_connected_to_the_server ));
                    }
                }
