                ...
                case ACCEPTED: // 电话接通成功
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
							...
							swing_card.setImageResource(R.mipmap.say);
                        }
...
//                                        callStateTextView.setText(st7);
	...
	public void onClick(View v) {
		...
		case R.id.iv_mute: // 静音开关
			if (isMuteState) {
				// 关闭静音
				muteImage.setImageResource(R.mipmap.un_jin);
				audioManager.setMicrophoneMute(false);
				isMuteState = false;
			} else {
				// 打开静音
				muteImage.setImageResource(R.mipmap.un_say);
		...
		case R.id.iv_handsfree: // 免提开关
			if (isHandsfreeState) {
				// 关闭免提
				handsFreeImage.setImageResource(R.mipmap.un_loudly);
				closeSpeakerOn();
				isHandsfreeState = false;
			} else {
				handsFreeImage.setImageResource(R.mipmap.loudly);
				openSpeakerOn();
